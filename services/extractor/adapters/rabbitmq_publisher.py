...
class RabbitMqPublisher(MessagePublisherPort):
    ...
    def connect(self) -> None:
        ...
        self._channel.queue_declare(queue="markets.enriched", durable=True)
        self._channel.queue_bind(exchange="polymarket", queue="markets.enriched", routing_key="markets.enriched")
